...
i386-elf-ld -o "build/full_kernel.bin" -Ttext 0x1000 "build/kernel_entry.o" "build/kernel.o" "build/util.o" "build/Text.o" "build/vga.o" "build/Font.o" "build/system.o" "build/idt.o" "build/isr.o" "build/irq.o" "build/idt_asm.o" "build/isr_asm.o" "build/timer.o" "build/irq_asm.o" "build/keyboard.o" "build/monitor.o" --oformat binary 
