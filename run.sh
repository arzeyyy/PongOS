...
i386-elf-ld -o  "build/full_kernel.bin" -T link.ld  "build/kernel_entry.o" "build/Game.o" "build/kernel.o" "build/screen.o" "build/util.o" "build/keyboard.o" "build/Font.o" "build/system.o" "build/idt.o" "build/isr.o" "build/pic.o" "build/idt_asm.o" "build/isr_asm.o" "build/timer.o" "build/irq_asm.o" -g -L/usr/local/i386elfgcc/lib/gcc/i386-elf/12.2.0 -lgcc  --oformat binary 
